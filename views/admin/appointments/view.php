<?php
// views/admin/appointments/view.php
...
?>
<?php $pageTitle = 'MediConnect - Appointment Details';
...
<div class="container container-wide">
    <a href="<?= (defined('BASE_PATH') ? BASE_PATH : '') ?>/index.php?route=admin/appointments&page=<?= $page ?? 1 ?>" class="back-link">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <span class="text-muted small">Created on <?= h($appointment['Created_At']) ?></span>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-6">
            <div class="card-section">
                ...
                <div class="info-item mb-4">
                    ...
                    <div class="badge bg-light text-dark border"><?= h($appointment['Visit_Type']) ?></div>
                </div>
                <div class="info-item">
        ...
        <div class="col-md-6">
            <div class="card-section">
                <div class="section-title"><i class="bi bi-person me-2"></i>Patient</div>
        ...
        <div class="col-md-6">
            <div class="card-section">
                ...
                <div class="fw-bold fs-5 mb-1"><?= h($appointment['Doctor_Name']) ?></div>
        ...
        <!-- Consultation Notes (Full Width) -->
         <div class="col-12">
            <div class="card-section">
                <div class="section-title"><i class="bi bi-journal-medical me-2"></i>Consultation Notes</div>
