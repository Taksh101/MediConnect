                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="action-btn-group">
                                            <a href="<?= (defined('BASE_PATH') ? BASE_PATH : '') ?>/index.php?route=patient/appointments/view&id=<?= (int)$a['Appointment_Id'] ?>" class="btn-icon view" title="View Details"><i class="bi bi-eye-fill"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
